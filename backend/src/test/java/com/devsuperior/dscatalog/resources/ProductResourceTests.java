...
public class ProductResourceTests {
	...
	public void deleteShouldReturnNotFoundWhenIdDoesNotExists() throws Exception{
		...
		String accessToken = tokenUtil.obtainAccessToken(mockMc, username, password);

		ResultActions result = 
				mockMc.perform(delete("/products/{id}", nonExistingId)
	...
	public void deleteShouldReturnNoContentWhenIdExists() throws Exception {
		...
		ResultActions result = 
				mockMc.perform(delete("/products/{id}", existingId)
						.header("Authorization", "Bearer " + accessToken)
						.accept(MediaType.ALL));	
	...
	public void updateShouldReturnProdctDTOWhenIdExists() throws Exception {
		...
		ResultActions result = 
				mockMc.perform(put("/products/{id}", existingId)
						.header("Authorization", "Bearer " + accessToken)
						.content(jsonBody)
						.contentType(MediaType.APPLICATION_JSON)
						.accept(MediaType.APPLICATION_JSON));
	...
	public void updateShouldReturnNotFoundWhenIdDoesNotExists() throws Exception {
		...
		ResultActions result = 
				mockMc.perform(put("/products/{id}", nonExistingId)
						.header("Authorization", "Bearer " + accessToken)
						.content(jsonBody)
						.contentType(MediaType.APPLICATION_JSON)
						.accept(MediaType.APPLICATION_JSON));
	...
	public void findByIdShouldReturnProductWhenIdExists() throws Exception{
		...
		ResultActions result = 
				mockMc.perform(get("/products/{id}", existingId)
						.accept(MediaType.APPLICATION_JSON));
	...
	public void findByIdShouldReturnNotFoundWhenIdDoesNotExists() throws Exception{
		...
		ResultActions result = 
				mockMc.perform(get("/products/{id}", nonExistingId)
						.accept(MediaType.APPLICATION_JSON));
